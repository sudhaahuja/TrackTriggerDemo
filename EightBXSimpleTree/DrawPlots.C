...
void DrawPlots(){
   ...
   TFile *in16 = new TFile("../Histograms_140PUTTBar_2GeV.root","READ");
	...
	TFile *in20 = new TFile("Histograms_TTbarTTbarPlus16PU200.root","READ");
   TFile *in21 = new TFile("Histograms_TTbarTTbarPlus16PU200_3GeV.root","READ");
	TFile *in22 = new TFile("Histograms_TTbarTTbarPlus12PU200.root","READ");
	TFile *in23 = new TFile("Histograms_TTbarTTbarPlus12PU200_3GeV.root","READ");
...
/*
   ...
   Draw(c10,in19,"",kRed,1);
	Draw(c10,in18,"same",kBlue,1);
   c10->SaveAs("PU200_2and3GeV.pdf");

   TCanvas *c11 = new TCanvas("c11","c11",1200,1200);
   c11->Divide(6,6);
   Draw(c11,in16,"",kRed,1);
   Draw(c11,in18,"same",kBlue,2);
   c11->SaveAs("PU140and200_2GeV.pdf");
*/
   TCanvas *c12 = new TCanvas("c12","c12",1200,1200);
   c12->Divide(6,6);
   Draw(c12,in21,"",kRed,1);
   Draw(c12,in20,"same",kBlue,1);
   c12->SaveAs("PU200_16BX.pdf");

   TCanvas *c13 = new TCanvas("c13","c13",1200,1200);
   c13->Divide(6,6);
   Draw(c13,in23,"",kRed,1);
   Draw(c13,in22,"same",kBlue,1);
   c13->SaveAs("PU200_12BX.pdf");

   TCanvas *c14 = new TCanvas("c14","c14",1200,1200);
   c14->Divide(6,6);
   Draw(c14,in8,"",kRed,1);
   Draw(c14,in4,"same",kBlue,1);
   c14->SaveAs("PU200_8BX.pdf");
