...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   TH1F *nSTUB_board01 = new TH1F("nSTUB_board01","nSTUB_board01",100,0,600);
   ...
   for (int t=0;t<48;t++){
      ...
      nStubTowerN.push_back(new TH1F(str, str, 100, 0, 10000));
   ...
   for (int t=0;t<48;t++) {
      ...
      for (int l=0;l<25;l++) {
         ...
         nStubLayerN.push_back(new TH1F(str, str, 100, 0, 1000));
...
*/
   ...
   for (int i=0;i<25;i++) {
      ...
      for (int l=0;l<76;l++) {
         ...
         for (int m=0;m<82;m++) {
            ...
            nStubTower16modN.push_back(new TH1F(str, str, 200, 0, 200));
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
	...
	nSTUB_board01->Write();
	TDirectory *Tower16 = newfile->mkdir("Tower16");
	Tower16->cd();
	nStubTowerN[16]->Write();
	TDirectory *Tower08 = newfile->mkdir("Tower08");
	Tower08->cd();
	nStubTowerN[8]->Write();
	TDirectory *Tower00 = newfile->mkdir("Tower00");
	Tower00->cd();
	nStubTowerN[0]->Write();
